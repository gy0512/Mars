...
namespace Mars.Pages
{
    class LoginPage
    {
        public void LoginSteps(IWebDriver driver)
        {
            ...
            driver.FindElement(By.Name("email")).SendKeys("0512gaoyuan@gmail.com");//driver.FindElement(By.XPath("/html/body/div[2]/div/div/div[1]/div/div[1]/input"))

            // password
            driver.FindElement(By.Name("password")).Click();
            driver.FindElement(By.Name("password")).Clear();
            driver.FindElement(By.Name("password")).SendKeys("123123");//driver.FindElement(By.XPath("/html/body/div[2]/div/div/div[1]/div/div[2]/input"))
            ...
            try
            {
                ...
                logincheck = driver.FindElement(By.XPath("//*[contains(text(),'Gary Gao')]")).GetAttribute("innerText");
